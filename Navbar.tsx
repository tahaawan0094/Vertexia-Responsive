...
export default function Navbar() {
  ...
  return (
    // UPDATED: 'sticky' is replaced with 'fixed left-0 w-full' to prevent pushing down the content and overlap correctly
    <header className="site-navbar fixed top-0 left-0 w-full z-50 bg-transparent shadow-none font-body">
      <div
        ...
        <div className="flex items-center flex-shrink-0">
          <a href="/" className="flex items-center gap-3" aria-label="Vertexia">
            <span
              ...
              className="text-white uppercase font-bold text-xl sm:text-xl lg:text-2xl"
            >
              VERTEXIA
            </span>
          </a>
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="absolute inset-x-0 top-full z-40 border-t border-white/10 bg-[#121212] shadow-none"
          >
