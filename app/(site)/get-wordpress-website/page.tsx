...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.vertexiaagency.com/get-wordpress-website",
  },
  openGraph: {
    title: "Get WordPress Website | Vertexia - Professional WordPress Web Development",
    description:
    ...
    url: "https://www.vertexiaagency.com/get-wordpress-website",
    type: "website",
    siteName: "Vertexia",
  },
  robots: {
...
export default function WordPressWebsitePage() {
  return (
    <PageTransition>
      <ServiceSchema title="WordPress Website Development" description="Professional WordPress website design and development service for businesses." url="https://www.vertexiaagency.com/get-wordpress-website" serviceType="ProfessionalService" />
      <BreadcrumbSchema pathname="/get-wordpress-website" title="Get WordPress Website" />
      <main className="site">
