...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.vertexiaagency.com/get-custom-website",
  },
  openGraph: {
    title: "Get Custom Website | Vertexia - Professional Web Design & Development",
    description:
    ...
    url: "https://www.vertexiaagency.com/get-custom-website",
    type: "website",
    siteName: "Vertexia",
  },
  robots: {
...
export default function DoneForYouWebsitePage() {
  return (
    <PageTransition>
      <ServiceSchema title="Custom Website Development" description="Professional custom website development service handled from start to finish." url="https://www.vertexiaagency.com/get-custom-website" serviceType="ProfessionalService" />
      <BreadcrumbSchema pathname="/get-custom-website" title="Get Custom Website" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="group">
                ...
                <ul className="space-y-2 text-white/70 text-sm">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-purple-500 mt-1">âœ“</span>
                    <span>Multiple payment methods: credit & debit cards PayPal, Stripeâ€”0% UENI commission</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-500 mt-1">âœ“</span>
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8 bg-slate-50">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-12 p-8 bg-white rounded-lg border-l-4 border-blue-600">
            ...
            <p className="text-slate-600 mb-4">We also offer <a href="https://www.vertexiaagency.com/get-wordpress-website" target="  _blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">WordPress website development</a> for those who prefer open-source solutions.</p>
          </div>
        </div>
      </section>
