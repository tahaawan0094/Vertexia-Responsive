...
export const metadata: Metadata = {
  title: "Website Concierge Service for online Businesses | Vertexia",
  description: "Vertexia offers concierge service with ongoing website support, management, maintenance, SEO, analytics & lead capture tools for business...",
  
  // ✅ Canonical ko alternates ke andar aise likhein:
  alternates: {
    canonical: "https://www.vertexiaagency.com/concierge-service",
  },

  openGraph: {
    title: "Website Concierge Service for online Businesses | Vertexia",
    description: "Vertexia offers concierge service with ongoing website support, management, maintenance, SEO, analytics & lead capture tools for business...",
    url: "https://www.vertexiaagency.com/concierge-service",
    type: "website",
  },
};
