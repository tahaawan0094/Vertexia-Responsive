// app/(site)/concierge-service/ConciergeClientPage.tsx
"use client";
...
export default function ConciergeClientPage() {
  return (
    <PageTransition>
      <ServiceSchema title="Concierge Website Support" description="Ongoing concierge website support and updates for growing businesses." url="https://www.vertexiaagency.com/concierge-service" serviceType="ProfessionalService" />
      <BreadcrumbSchema pathname="/concierge-service" title="Concierge Service" />
