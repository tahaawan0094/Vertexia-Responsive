...
export default function ConciergeHeroSection() {
  return (
    <section className="relative overflow-visible pb-24 pt-16 text-center px-4 max-[640px]:pb-16 max-[640px]:pt-10 max-[420px]:px-3 bg-[#0a0a0a]">
      {/* 🌌 TOP FADE: Top edges ko seamlessly blend karne ke liye */}
      <div
        className="pointer-events-none absolute inset-x-0 top-0 h-[180px] bg-[linear-gradient(180deg,#0a0a0a_0%,rgba(10,10,10,0)_100%)] z-10"
        aria-hidden="true"
      />

      {/* 🌟 ULTRA BLEND BOTTOM GRADIENT: 
        Yeh video background ko bottom page layout aur content ke sath blend karega
      */}
      <div
        className="pointer-events-none absolute inset-x-0 bottom-0 h-[300px] bg-gradient-to-t from-[#0a0a0a] via-[#0a0a0a]/90 to-transparent z-10"
        aria-hidden="true"
      />

      {/* 🎬 Video Background Container (ADDED) */}
      <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
        ...
        >
          {/* Public folder path is mapped directly to the root '/' */}
          <source src="/concirege-services-vertexia.mp4" type="video/mp4" />
        </video>
        
        {/* Soft Radial Mask: Center highlighting aur dark boundaries ke liye */}
        <div 
          className="pointer-events-none absolute inset-0 h-full w-full bg-[radial-gradient(circle_at_50%_50%,rgba(10,10,10,0)_30%,#0a0a0a_100%)] opacity-75" 
          aria-hidden="true"
        />
      </div>

      {/* Content Container: Increased z-index so content stays interactable and sharp */}
      <div className="relative z-20 mx-auto flex max-w-[1280px] flex-col items-center justify-start gap-8 px-4 pt-10 pb-2 sm:px-6 sm:py-14 lg:px-8">
        {/* Available Badge */}
        ...
        <div className="relative mt-20 w-full max-w-[1200px] mx-auto">
          ...
          <div className="relative w-full aspect-[1231/741] z-10 rounded-2xl bg-[#0b0b0b] shadow-[0_30px_80px_rgba(0,0,0,0.8)] overflow-visible">
            {/* Table-vertexia.svg holds browser frame */}
            <img
              src="/concierge services images/Table-vertexia.svg"
              alt="Browser Frame"
            ...
            >
              <img
                src="/concierge services images/concierge-services-vertexia.webp"
                alt="Concierge Services Website Preview"
                className="w-full h-full object-cover object-top opacity-0"
              />
            </div>

            {/* Overlay 1: Floating pill gradient-lights.svg */}
            ...
            {/* Overlay 2: Floating card vertexia-concierge.webp */}
            <div className="absolute -left-[8%] bottom-[5%] w-[22%] min-w-[110px] z-30 transition duration-300 animate-float-1 drop-shadow-[0_15px_30px_rgba(0,0,0,0.6)]">
              <img
                src="/concierge services images/vertexia-concierge.webp"
                alt="Suzan McKin - Support Specialist"
                className="w-full h-auto rounded-[14px]"
              />
            </div>

            {/* Overlay 3: Floating card VERTEXIA.webp */}
            <div className="absolute -right-[8%] bottom-[8%] w-[22%] min-w-[110px] z-30 transition duration-300 animate-float-2 drop-shadow-[0_15px_30px_rgba(0,0,0,0.6)]">
              <div className="relative w-full h-full">
                ...
                <img
                  src="/concierge services images/VERTEXIA.webp"
                  alt="Vertexia Support Expert"
                  className="w-full h-auto rounded-[14px]"
                />
              </div>
            </div>

            {/* Overlay 4: Floating publish btn.svg */}
            ...
            {/* Overlay 5: Floating typography selector table-box.svg */}
